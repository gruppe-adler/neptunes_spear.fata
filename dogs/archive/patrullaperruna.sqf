...
//----------------------------------------------------------------------------------------------------------
		...
		call compile format ['"%2" createUnit [_position, _grupo,"%1=this; this setSpeedMode ""NORMAL""; this setbehaviour ""SAFE""",1]',_NombrePerro,_raza];
...
//----------------------------------------------------------------------------------------------------------		
			...
			_HumanosCerca = nearestObjects [position _perro, ["man"], 50];
...
//----------------------------------------------------------------------------------------------------------	
				  		...
				  		if (count _HumanosVivos >0)  then {							
							...
							if ((_distancia > 40) && (_distancia < 50)) then {
							...
							if ((_distancia > 30) && (_distancia < 40)) then {
							...
							if ((_distancia > 20) && (_distancia < 30)) then {
							...
							if ((_distancia > 15) && (_distancia < 20)) then {					
